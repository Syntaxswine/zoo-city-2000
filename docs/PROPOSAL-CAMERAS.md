...
**Integration, 2026-09-05:** recovered from origin/cameras (bf659ec) and merged with the current city. The historical design and measurements below describe the original branch; current custody and camping rules change population and clearance outcomes. See [integration evidence](HANDOFF-BACKLOG-CLOSURE-2026-09-05.md).
