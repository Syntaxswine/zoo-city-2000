...
**THE NEWS MIX AFTER THE MARKET — found 2026-09-26, OPEN:** `tools/newsprobe.mjs` (an instrument, not a gate) asks that people be at most 40% of the news. It failed on seed 5 before the market was built (40.1% at `8cb6f35`), and at `05ce7eb` it fails on seeds 7 and 5 — 45.4% and 46.7% (seed 3 36.5%, seed 11 29.4%): one market makes fewer meat headlines than eleven zoned halls did, so births, deaths and the rest take a larger share. Every named animal still resolves and survives save/load. The bar and the mix want a look together; nothing in the build depends on it.
