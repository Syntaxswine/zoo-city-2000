...
- [ ] **Open for the owner:** TAX_CLASS modest ×2 against a town-wide modest class (one number; the table above); MANSION_P 0.25 against three mansions in fourteen months hollowing a quarter and a third of a town into tents (a rate, a cap per quarter or a fill rule — one knob each); a mansion rises on EMPTY chalk the month the amenities land.
