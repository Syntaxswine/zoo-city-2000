...
export const RULES = Object.freeze([
  ...
  },
  {
    ...
    formula: "served ⇔ min roadDist over the FOOTPRINT ≤ ROAD_REACH (BFS through any tile, round a bare wall) — a lot, a block, a hall, a zoo, one question. A STATION is asked the same question a different way: nobody walks a lot's gap, but a platform's forecourt is walked tile by tile, so it is a search over ground an animal can stand on (not water, not a wall, not a building) rather than a distance; doors = every road tile at that distance",
