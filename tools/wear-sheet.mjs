...
const choices=[[1,1,0,1],[1,3,2,1],[2,1,0,1],[3,2,1,1],[2,2,0,1],[1,3,0,2]]; // row 5 was the meat cold store, retired with zone 4 (2026-09-26): a C store of its height now
