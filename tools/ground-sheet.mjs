...
// prints the readings from tools/groundprobe.mjs and draws three bands:
//
...
//   the bottom band  the edge of a town at zoom 2 and zoom 1: roads, lots, a
...
// ---- the bottom band: the edge of a town -------------------------------------------
...
const sheet = createCanvas(W, topH + 2 * PH + 5 * GAP);
...
console.log(`ground sheet: ${combos.length} corner combinations at 2×, an open field at zoom 1 and 2, a town's edge at zoom 2 and 1`);
